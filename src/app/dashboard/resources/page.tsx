      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-400 mt-1">
              Curated guides, playlists, cheatsheets, and resources for tech placements.
            </p>
          </div>
          {isAdmin && (
            <Button
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <Card key={i} className="glass-panel p-6 space-y-4 skeleton-pulse h-64" />
            ))}
          </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center gap-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      <span className={`text-[9px] font-bold px-2 py-0.5 rounded-full ${getDifficultyBadge(item.difficultyLevel)}`}>
          ...
          <Card className="glass-panel p-12 text-center space-y-4 max-w-md mx-auto">
            ...
            <p className="text-slate-400 text-sm">
              We couldn't find any placement study resources matching your selected criteria. Try adjusting your query or category filters.
            </p>
            <Button
              onClick={() => {
                setSearchQuery('');
