          ...
          <div className="space-y-6">
            ...
            <div className="px-4 flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-sm text-white leading-none">SkillBridge</span>
                <span className="text-[9px] text-indigo-400 font-bold uppercase tracking-widest mt-0.5">Admin Workspace</span>
              </div>
            </div>

            {/* Links Stack */}
            <nav className="space-y-1.5">
              <SidebarLink href="/admin" iconName="dashboard" name="Dashboard" />
              <SidebarLink href="/admin/users" iconName="users" name="User Management" />
              <SidebarLink href="/admin/resources" iconName="resources" name="Resource Management" />
            </nav>
          </div>
